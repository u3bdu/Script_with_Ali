#Ring Test for nokia , result to output file in my lap
...
df = pd.read_excel(r'/home/user/Excel/RBG17.xlsx', sheet_name="FDTs")
...
for _, row in df.iterrows():
    ...
    excel_filename = rf'/home/user/result/{Ring}.xlsx'
