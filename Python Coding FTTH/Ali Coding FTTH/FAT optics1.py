#لاستخراج داتا اليوزرية من الاولتي ومقارنتها مع شيت مسحوب من الكريشيو لكل يوزر بأي فات , وعمل جدول يشمل كل يوزر بأي فات مع بوراته
...
df = pd.read_excel('FDT1.xlsx', sheet_name="SN")
# Read Excel file using pandas
df2 = pd.read_excel('FDT1.xlsx', sheet_name="SN2")
...
pool = ThreadPoolExecutor(max_workers=1)
# Usage example
max_u_value = 400  # Change this to the maximum U value you want to query
